                ...
                <div class="col-sm-9 page-content col-thin-right">
                    ...
                    <div class="inner inner-box ads-details-wrapper">
                        ...
                        <div class="ads-image">
                            ...
                            @else
                                <img src="{{ asset('styleWeb/assets/sin_imagen_grande.png') }}"
                                    alt="{{ $service->title }}" class="img-responsive" />
                            @endif
                        </div>
                        ...
                        <div class="Ads-Details">
                            ...
                            {{--  <a class="resp-sharing-button__link"
                                href="https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Favisosmendoza.com.ar"
                            ...
                            <a class="resp-sharing-button__link"
                                href="https://twitter.com/intent/tweet/?text=Servicio%20en%20avisosmendoza.com.ar&amp;url=https%3A%2F%2Favisosmendoza.com.ar"
                                target="_blank" rel="noopener" aria-label="">
                            ...
                            <a class="resp-sharing-button__link"
                                href="mailto:?subject=Servicio%20en%20avisosmendoza.com.ar&amp;body=https%3A%2F%2Favisosmendoza.com.ar"
                            ...
                            <a class="resp-sharing-button__link"
                                href="whatsapp://send?text=Servicio%20en%20avisosmendoza.com.ar%20https%3A%2F%2Favisosmendoza.com.ar"
                                target="_blank" rel="noopener" aria-label="">
                        ...
                        {{--  <div class="content-footer text-left">
                            <div class="w100 map" id="prop-map">
                                <iframe width="100%" height="350%" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA3PJbyaIm2xE1m673dgjVnkwP55r-UWnk
                                                                    &q={{ $service->region->name . ',mendoza' }}"
                                    allowfullscreen>
                                </iframe>
                            </div>
                            <div style="clear: both"></div>
