        ...
        <div class="row">
            ...
            <div class="col-sm-9 page-content col-thin-left">
                ...
                <div class="category-list">
                    <div class="tab-box clearfix ">
                        ...
                        <div class="col-lg-12  box-title no-border">
                            <div class="inner">
                                <h2><span>
                                        {{ basename(Request::url()) != 'listado' ? $category->name : 'Todos los
                                        servicios' }}
                                    </span>
                                    <small> {{ $serviceCount }} encontrados</small>
                                </h2>
                            </div>
                        </div>
                        ...
                        <div class="item-list job-item">
                            ...
                            <div class="col-sm-10  col-xs-10  add-desc-box">
                                <div class="add-details jobs-item">
                                    ...
                                    <span class="photo-count"> Destacado </span>
                                    @endif
                                    ...
                                    <span class="info-row">
                                        ...
                                        <span class="item-location"><i class="fa fa-clock-o"></i>
                ...
                <div class="post-promo text-center">
                    ...
                    <a href="{{ route('service.create') }}" class="btn btn-lg btn-border btn-post btn-danger">Publicar
                        Servicio </a>
                </div>
                @else
                <div class="post-promo text-center">
                    <h2> ¿Querés publicar tu servicio? </h2>
                    <h5> ¡Registrate totalmente Gratis y publicá tu servicio. Llegá a más clientes! </h5>
                    <a href="{{ route('dashboard.changeType', userConnect()) }}" id="button2id" name="button2id"
                        class="btn btn-warning btn-post">Convertite en
                        anunciante
                    </a>
                </div>
                @endif
                ...
                <div class="post-promo text-center">
                    <h2> ¿Querés publicar tu servicio? </h2>
                    <h5> ¡Registrate totalmente Gratis y publicá tu servicio. Llegá a más clientes! </h5>
                    <a href="{{ route('register') }}" class="btn btn-lg btn-border btn-post btn-danger">Registrate
                        Gratis </a>
                </div>
                @endif
            </div>
...
<script async src="{{ asset('styleWeb/assets/plugins/jquery.fs.scroller/jquery.fs.scroller-min.js') }}"></script>
<script async src="{{ asset('styleWeb/assets/plugins/jquery.fs.selecter/jquery.fs.selecter.min.js') }}"></script>
<script async src="{{ asset('styleWeb/assets/js/script-min.js') }}"></script>
@endsection