        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box">
                        <h2 class="title-2">Servicios Pendientes </h2>
                                    ...
                                    @foreach ($services as $service)
                                        <tr>
                                            <td style="width:14%" class="add-img-td">
                                                @if ($service->photo)
                                                    <a href="{{ $service->status == 'Activo' ? route('service', [$service->slug, $service->ref]) : '#'}}">
                                            ...
                                            <td style="width:58%" class="ads-details-td">
                                                <div>
                                                    <p><strong> <a
                                                                href="{{ $service->status == 'Activo' ? route('service', [$service->slug, $service->ref]) : '#' }}"
                                                                title="{{ $service->name }}">
                                                                {{ $service->title }}
                                                            </a> </strong></p>
