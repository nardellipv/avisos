    ...
    <div class="author big">
        <div class="author-image">
            <div class="background-image">
                ...
                @else
                    <img src="{{ asset('styleWeb/assets/user.png') }}" alt="foto perfil">
                @endif
        ...
        <div class="author-description">
            ...
            @if (userConnect()->type == 'Anunciante')
                @if ($countService == 0)
                    ...
                    <p>Trabajamos diariamente para que tus publicaciones lleguen a la mayor cantidad de mendocinos
                        posibles.</p>
                @endif
        ...
        @if (userConnect()->type == 'Anunciante')
            ...
            @else
                <section>
                    <a href="{{ route('dashboard.changeType', $user) }}" class="btn btn-warning"
                        style="margin-left: 5%;">Convertite en
                        anunciante
                    </a>
                </section>
        @endif
