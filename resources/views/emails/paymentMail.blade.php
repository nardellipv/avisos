...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" bgcolor="#303030"
        ...
        <tr>
            <td style="background-image: url('images/not5_bg_image.jpg'); -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-position: center center; background-repeat: no-repeat;"
                id="not5">
                    ...
                    <tr>
                        ...
                        <td align="center" width="352" valign="middle">
                            ...
                            <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="full">
                                <tr>
                                    <td align="center" width="352" valign="middle" bgcolor="#ffffff"
                                        ...
                                        <div class="sortable_inner ui-sortable">
                                                        ...
                                                        <table width="300" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td valign="middle" width="100%"
                                                                    style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 23px; color: rgb(63, 67, 69); line-height: 28px; font-weight: bold;"
                                                                    class="fullCenter">
                                                                    <!--[if !mso]><!--><span
                                                ...
                                                <tr>
                                                    <td width="352" valign="middle" align="center">
                                                        <table width="300" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td valign="middle" width="100%"
                                                                    style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 12px; color: rgb(63, 67, 69); line-height: 46px; font-weight: bold;"
                                                                    class="fullCenter">
                                                                    <!--[if !mso]><!--><span
                                                                        style="font-family: 'proxima_nova_rgbold', Helvetica; font-weight: normal;">
                                                                        <!--<![endif]-->A continuación listamos los
                                                                        beneficios de destacar un anuncio
                                                                        <!--[if !mso]><!-->
                                                                    </span>
                                                                    <!--<![endif]-->
                                                                </td>
                                                ...
                                                <tr>
                                                    <td width="352" valign="middle">
                                                        ...
                                                        <table width="352" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td width="100%" height="1" bgcolor="#e5e5e5"
                                            ...
                                            <table class="mobile" style="background-color: #ffffff;" border="0"
                                                width="352" cellspacing="0" cellpadding="0" align="center"
                                                bgcolor="#ffffff">
                                                <tbody>
                                                    <tr>
                                                        <td align="center" valign="middle" width="352">
                                                            <!-- Buttons + Text -->
                                                            <table class="fullCenter"
                                                                style="text-align: center; border-collapse: collapse; height: 478px;"
                                                                border="0" width="521" cellspacing="0" cellpadding="0"
                                                                align="center">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="width: 519px;" height="30">&nbsp;
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="fullCenter"
                                                                            style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #3f4345; line-height: 24px; width: 519px;"
                                                                            valign="middle">
                                                                            <ul class="list-check"
                                                                                style="list-style-type: circle;">
                                                                                <li style="text-align: left;">
                                                                                    <strong>Puedes destacar todos los
                                                                                ...
                                                                                <li style="text-align: left;"><strong>Se
                                                                                        destacan en la primera
                                                                                        posici&oacute;n de los servicios
                                                                                        listados</strong></li>
                                                                                <li style="text-align: left;"><strong>La
                                                                                        publicaci&oacute;n se realiza
                                                                                        autom&aacute;ticamente</strong>
                                                                                </li>
                                                                                <li style="text-align: left;"><strong>Se
                                                                                        comparten en nuestras redes
                                                                                        sociales</strong></li>
                                                                            </ul>
                                                                            <br /><span
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #3f4345; line-height: 24px; width: 519px;">
                                                                            <strong><span style="color: #ff0000;">Todo
                                                                                    por $200 cada 60
                                                                                    d&iacute;as</span><br /></strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #3f4345; line-height: 24px; width: 519px;">
                                                                            Podes destacar tu servicio
                                                                            <strong> {{ $service->title }}</strong>&nbsp;realizando
                                                                            un pago desde el siguiente
                                                                            bot&oacute;n<strong><span
                                                                                    style="color: #ff0000;"><br /></span></strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <div class="button-container"
                                                                                style="padding: 15px;" align="center"><a
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div class="button-container"
                                                                                ...
                                                                                <span
                                                                                    style="padding-left: 50px; padding-right: 50px; font-size: 18px; display: inline-block; letter-spacing: normal;"><span
                                                                                        style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
                                                                                            style="font-size: 18px; line-height: 36px;"><strong>&nbsp;</strong></span></span></span>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <div class="button-container"
                                                                                ...
                                                                                <span
                                                                                    style="padding-left: 50px; padding-right: 50px; font-size: 18px; display: inline-block; letter-spacing: normal;"><span
                                                                                        style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
                                                                                            style="font-size: 18px; line-height: 36px;"><strong>
                                                                                                <h6
