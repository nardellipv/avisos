<table class="nl-container"
    ...
    role="presentation" width="100%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    <tbody>
                                    ...
                                    <div style="border: 0px solid transparent; padding: 0px 0px 5px 0px;">
                                        ...
                                        <div class="img-container center fixedwidth"
                                            ...
                                            <!-- [if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img
                                                ...
                                                alt="your-logo" width="125" align="center" border="0" />
                    ...
                    <div class="block-grid"
                        ...
                        <div
                            ...
                            <div class="col num12"
                                ...
                                <div class="col_cont" style="width: 100% !important;">
                                    <!-- [if (!mso)&(!IE)]><!-->
                                    <div style="border: 0px solid transparent; padding: 5px 0px 0px 0px;">
                                        <!--<![endif]-->
                                ...
                                <div class="col_cont" style="width: 100% !important;">
                                    ...
                                    <div style="border: 0px solid transparent; padding: 0px 0px 5px 0px;">
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                <tr style="vertical-align: top;" valign="top">
                                                    <td style="word-break: break-word; vertical-align: top; text-align: center; width: 100%; padding: 0px;"
                                                        ...
                                                        <h1
                                                            ...
                                                            <strong>Hola, {{ $service->user->name }}</strong>
                                                        </h1>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <div
                                            ...
                                            <p
                                                style="margin: 0px; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: left;">
                                                &nbsp;</p>
                                            <ul class="list-check">
                                                <li><span style="color: #0000ff;">Puedes destacar todos los servicios
                                                        que desees</span></li>
                                                <li><span style="color: #0000ff;">Se promocionan por 60
                                                        d&iacute;as</span></li>
                                                <li><span style="color: #0000ff;">Tus servicios se destacan en la
                                                        p&aacute;gina principal</span></li>
                                                <li><span style="color: #0000ff;">Se destacan en la primera
                                                        posici&oacute;n de los servicios listados</span></li>
                                                <li><span style="color: #0000ff;">La publicaci&oacute;n se realiza
                                                        autom&aacute;ticamente</span></li>
                                                <li><span style="color: #0000ff;">Se comparten en nuestras redes
                                                        sociales</span></li>
                                            </ul>
                                            <p style="text-align: center;"><span style="color: #ff0000;">Todo por $200
                                                    cada 60 d&iacute;as</span></p>
                                            <p
                                            ...
                                            <p
                                                style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                Podes destacar tu servicio <strong> {{ $service->title }}</strong>
                                                realizando un pago
                                            ...
                                            <h6 style="text-align: center;">Te agradecemos por confiar en Avisos Mendoza,
                                                un sitio que crece constantemente gracias a todos ustedes que confian en
                                                nosotros y nuestro arduo trabajo.</h6>
                                        </div>
                                    </div>
                                    <!--<![endif]-->
                                </div>
                                ...
                                <div class="col_cont" style="width: 100% !important;">
                                    ...
                                    <div style="border: 0px solid transparent; padding: 5px 0px 5px 0px;">
                                        ...
                                        <table class="social_icons"
                                            ...
                                            <tbody>
                                                <tr style="vertical-align: top;" valign="top">
                                                    <td style="word-break: break-word; vertical-align: top; padding: 0px;"
                                                        valign="top">
                                                        <table class="social_table"
                                                            style="table-layout: fixed; vertical-align: top; border-spacing: 0px; border-collapse: collapse; width: 43px;"
                                                            role="presentation" cellspacing="0" cellpadding="0"
                                                            align="center">
                                                            <tbody>
                                                                <tr style="vertical-align: top; display: inline-block; text-align: center;"
                                                                    align="center" valign="top">
                                                                    <td style="word-break: break-word; vertical-align: top; padding-bottom: 0px; padding-right: 5px; padding-left: 5px; width: 32px;"
