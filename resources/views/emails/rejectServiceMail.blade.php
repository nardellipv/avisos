                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        Tu servicio fue <b>Desaprobado</b> por un administrador,
                                                        lamentamos el inconveniente, puedes volver a
                                                        publicar otro aviso cuando gustes, muchas gracias
                                                        por participar de Avisos Mendoza.</p>
                                                    <p
                                                        style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                        El motivo que encontro nustro administrador fue:</p>
                                                    <p
                                                        style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                        <b>{{ $motive }}</b>
                                                    </p>
