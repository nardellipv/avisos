                                                        ...
                                                        <table width="265" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td valign="middle" width="100%"
                                                                    style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 22px; color: rgb(63, 67, 69); line-height: 48px;"
                                                                    class="fullCenter">
                                                                    <!--[if !mso]><!--><span
                                                            ...
                                                            <tr>
                                                                <td width="265" bgcolor="#fdba30" class="pad15"
                                                                    ...
                                                                    <table width="240" border="0" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td valign="middle" width="100%"
                                                                                style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 16px; color: rgb(63, 67, 69); line-height: 34px;"
                                                                                class="fullCenter">
                                                                                <!--[if !mso]><!--><span
                                                                                    style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;">
                                                                                    <!--<![endif]-->Te contactaron desde el sitio avisos mendoza por tu servicio <strong>{{ $data['title_service'] }}</strong>,
