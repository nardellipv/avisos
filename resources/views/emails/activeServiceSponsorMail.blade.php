                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        Tu servicio ya se esta destacando en Avisos Mendoza, muchas
                                                        gracias por participar en el sitio.</p>
                                                    <p
                                                        style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                        Esperamos que puedas contactar a muchos más clientes dentro de
                                                        tu zona.</p>
                                                    <h6
                                                        style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                        Puedes contactarte con nosotros a través de clientes@avisosmendoza.com.ar</h6>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
