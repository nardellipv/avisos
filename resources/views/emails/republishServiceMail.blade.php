                                                        ...
                                                        <table width="300" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td width="100%"><span><img
                                                                            src="https://avisosmendoza.com.ar/styleWeb/assets/logo.png" width="61"
                                                                            alt="" border="0"></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td width="352" valign="middle" align="center">
                                                        <table width="300" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td valign="middle" width="100%"
                                                                    style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 40px; color: rgb(63, 67, 69); line-height: 46px; font-weight: bold;"
                                                                    class="fullCenter">
                                                                    <!--[if !mso]><!--><span
                                                                        style="font-family: 'proxima_nova_rgbold', Helvetica; font-weight: normal;">
                                                                        <!--<![endif]-->Tu servicio esta listo!
                                                                        <!--[if !mso]><!-->
                                                                    </span>
                                                                    <!--<![endif]-->
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td valign="middle" width="100%"
                                                                    ...
                                                                    <!--[if !mso]><!--><span
                                                                        ...
                                                                        <!--<![endif]-->Tu servicio fue <b>republicado</b> por un administrador, muchas gracias
                                                                        por participar de Avisos Mendoza.
                                                                        <p>Esperamos que puedas contactar a muchos más clientes dentro de tu zona.</p>
                                                                        <!--[if !mso]><!-->
                                                                    </span>
                                                                    <!--<![endif]-->
                                                                </td>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" height="35"
                                                                                bgcolor="#fe4646"
                                                                                style="border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px; padding-left: 30px; padding-right: 30px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); text-transform: uppercase; background-color: rgb(254, 70, 70);">
                                                                                <!--[if !mso]><!--><span
                                                                                    style="font-family: 'proxima_nova_rgbold', Helvetica; font-weight: normal;">
                                                                                    <!--<![endif]-->
                                                                                    <a href="https://avisosmendoza.com.ar"
                                                                                        style="color: rgb(255, 255, 255); font-size: 14px; text-decoration: none; line-height: 35px; width: 100%;">Ir a Avisos Mendoza</a>
                                                                                    <!--[if !mso]><!-->
                                                                                </span>
                                                                                <!--<![endif]-->
                                                                            </td>
