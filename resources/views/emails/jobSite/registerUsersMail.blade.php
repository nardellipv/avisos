                                        ...
                                        <div
                                            ...
                                            <div class="txtTinyMce-wrapper"
                                                ...
                                                <p
                                                    ...
                                                    Usuarios registrados en el &uacute;ltimo mes</p>
                                                <p
                                                    style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                    &nbsp;</p>
                                                <p
                                                    style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                    Listados de usuarios:</p>
                                                <table style="border-collapse: collapse; width: 100%;" border="1">
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                style="width: 25%; border-style: solid; text-align: center; background-color: #fcd6cd; border-color: #fcd6cd;">
                                                                Nombre</td>
                                                            <td
                                                                style="width: 25%; border-style: solid; text-align: center; background-color: #fcd6cd; border-color: #fcd6cd;">
                                                                Apellido</td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 25%; border-style: solid;">{{ $user->name }}</td>
                                                            <td style="width: 25%; border-style: solid;">{{ $user->lastname }}</td>
                                                            <td style="width: 25%; border-style: solid;">{{ $user->email }}</td>
                                                            <td style="width: 25%; border-style: solid;">{{ $user->type }}</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
