                                                ...
                                                <tr style="vertical-align: top;" valign="top">
                                                    <td style="word-break: break-word; vertical-align: top; text-align: center; width: 100%; padding: 0px;"
                                                        ...
                                                        <h1
                                                            ...
                                                            <strong>Hola, {{ $user->name }}</strong></h1>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <div
                                            ...
                                            <div class="txtTinyMce-wrapper"
                                                ...
                                                <p
                                                    ...
                                                    Hace mucho tiempo no vienes por Avisos Mendoza y te
                                                    extra&ntilde;amos <img
                                                        src="https://html-online.com/editor/tiny4_9_11/plugins/emoticons/img/smiley-cry.gif"
                                                        alt="cry" /></p>
                                                <p
                                                    style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                    Si tienes servicios publicados, te recomendamos actualizarlos para
                                                    que aparezcan primeros en los listados y así los visitantes de
                                                    Avisos Mendoza puedan ubicarte mucho m&aacute;s f&aacute;cil y puedas
                                                    generar nuevos clientes.</p>
                                            </div>
                                        </div>
                                        <!-- [if mso]></td></tr></table><![endif]-->
                            ...
                            <div class="col num12"
                                ...
                                <div class="col_cont" style="width: 100% !important;">
                                    ...
                                    <div style="border: 0px solid transparent; padding: 5px 0px 5px 0px;">
                                        <!--<![endif]-->
                                        <h6 style="text-align: center;"><span style="color: #ff0000;">Muchas gracias por
                                                participar de nuestra comunidad</span></h6>
