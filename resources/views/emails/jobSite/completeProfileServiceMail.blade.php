                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        Te estamos enviando este email ya que tu servicio
                                                        <b>{{ $service->title }}</b> no esta completo, te recomendamos
                                                        completar el
                                                        perfil de tu servicio.</p>
                                                    <p
                                                        style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                        También recomendamos que lo renueves cada cierto tiempo para que
                                                        sigas llegando a muchos más potenciales clientes.</p>
                                                    <p
                                                        style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
